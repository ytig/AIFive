    ...
    public FiveGame() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                setSize(chessSize * pieceLength + (set != null ? set.left : 0), chessSize * pieceLength + (set != null ? set.top : 0));
                setResizable(false);
                init();
            }
        });
    ...
    private void showResult(int result) {
        ...
        switch (result) {
            case 1: //赢
                ...
                winCount++;
                if (winCount >= 100) {
                    JOptionPane.showMessageDialog(null, "您是人工智能吗？", "", JOptionPane.QUESTION_MESSAGE);
                    return;
                }
                if (winCount >= 5) {
...
class Item extends JButton {
    ...
    public interface OnClickListener {
        void onClick(int x, int y, JButton item);
    }
}
